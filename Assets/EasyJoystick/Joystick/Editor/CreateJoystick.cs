...
public static class CreateJoystickMenuItem 
{
	...
	[MenuItem("GameObject/UI/EasyJoystick", false, 2020)]
	public static void CreateJoystick()
	{
		GameObject joystick = new GameObject("EasyJoystick", typeof(Image), typeof(EasyJoystick) , typeof(CanvasGroup));
		...
		Debug.Log("EasyJoystick has been created");
